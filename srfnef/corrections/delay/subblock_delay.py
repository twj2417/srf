...
class SubblockDelaySolver:
    ...
    def __call__(self, num: int, filename) -> np.ndarray:
        ...
        for ind in nef.utils.tqdm(range(num)):
            ...
            all_sub_id = crystal_id // self.scanner.nb_crystal_per_submodule
            ...
            snd_ind = fst_ind + 1
            ind1 = all_sub_id[fst_ind]
            ind2 = all_sub_id[snd_ind]
            inv = ind1 > ind2
